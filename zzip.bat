...
advzipNT -a4 -i 32 AltDrag_src.zip AltDrag.txt AltDrag.ini License.txt altdrag.c altdrag.rc config.c hooks.c hooks.rc languages.c languages.h resource.h tray.c unfuck.h window.rc x86.exe.manifest mk.bat media\* Lang\*
